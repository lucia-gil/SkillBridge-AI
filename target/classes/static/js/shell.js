...
(function () {
    ...
    function sidebarHtml(roleSlug, config, activeHref) {
        ...
        return (
            ...
            // Sin sidebar-footer: el menú de usuario (Mi cuenta / Cerrar sesión)
            // ya vive en la topbar (topbarHtml -> user-menu-topbar), igual que en
            // el resto de la app real (fragments/topbar.html). Tenerlo también
            // acá abajo era un duplicado del shell JS legacy, con su propia
            // línea divisoria y botón de "···" que no debían estar.
        );
    }
