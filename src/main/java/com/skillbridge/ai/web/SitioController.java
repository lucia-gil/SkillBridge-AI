...
public class SitioController {
    ...
    // Resource Manager: inicio/reportes/ocupacion/asignaciones/colaboradores/
    // ai-talent-matching YA tienen controlador real (RmInicioController,
    // RmReportesController, RmOcupacionController, RmAsignacionesController,
    // RmColaboradoresController, TalentMatchingController).
    @GetMapping({
