...
public class AdminInicioController {
    ...
    public String inicio(HttpSession session, Model model) {
        ...
        // Vista rápida del dashboard: hasta 24 cuentas (4 páginas de 6, paginación
        // en puntos en el cliente - ver pagination.js). El listado completo con
        // paginación numerada vive en usuarios.html ("Ver todos").
        model.addAttribute("usuariosPreview", usuarios.size() > 24 ? usuarios.subList(0, 24) : usuarios);
