-- =====================================================================
-- SkillBridge AI — Modelo de datos v3 (Entregable 2: Base de Datos)
...
-- ---------------------------------------------------------------------
-- 19. EVENTOS_PROYECTO — Calendario automático por colaborador (NUEVO)
...
CREATE TABLE eventos_proyecto (
    ...
    proyecto_id         BIGINT UNSIGNED NOT NULL,
    creado_por_id       BIGINT UNSIGNED NOT NULL,
    tipo                ENUM('entregable', 'reunion', 'hito') NOT NULL,
    titulo              VARCHAR(150) NOT NULL,
    descripcion         TEXT NULL,
    ...
    dirigido_a          ENUM('todos', 'solo_pm', 'solo_colaboradores') NOT NULL DEFAULT 'todos',
